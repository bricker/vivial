...
import { HEADER, INTEGRATION_LOGOS } from '../../../constants';
...
import { getTrackingInfo, saveCookie, cookiePrefix } from '../../../cookies';
...
const ACCESS_REQUEST_URL = `${window.eave.apiBase}/access_request`;
