...
from eave.stdlib.pgtracing.pg_trace import start_postgresql_listener

_sockaddr = "/tmp/eave_pg_agent.sock"
_endmsg = "EOF"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        prog="Eave Ppstgresql trace agent", description="Starts listening for database change events"
    )
