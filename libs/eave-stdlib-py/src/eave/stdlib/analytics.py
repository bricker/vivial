...
async def log_event(
    event_name: str,
    ctx: _l.LogContext | None,
    event_description: str | None = None,
    event_source: str | None = None,
    opaque_params: JsonObject | None = None,
    eave_account: AnalyticsAccount | None = None,
    eave_team: AnalyticsTeam | None = None,
) -> None:
...
async def _send_event(event: typing.Any, topic_id: str, ctx: _l.LogContext | None = None) -> None:
    """
