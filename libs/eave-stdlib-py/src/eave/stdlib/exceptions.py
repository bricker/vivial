...
class HTTPException(starlette.exceptions.HTTPException):
    ...
    def __init__(self, status_code: int, detail: typing.Optional[str] = None, headers: typing.Optional[dict[str, str]] = None, request_id: typing.Optional[str] = None) -> None:
        self.request_id = request_id
        super().__init__(status_code=status_code, detail=detail, headers=headers)

class BadRequestError(HTTPException):
    def __init__(self, detail: typing.Optional[str] = None, headers: typing.Optional[dict[str, str]] = None, request_id: typing.Optional[str] = None) -> None:
...
class InternalServerError(HTTPException):
    def __init__(self, detail: typing.Optional[str] = None, headers: typing.Optional[dict[str, str]] = None, request_id: typing.Optional[str] = None) -> None:
        super().__init__(status_code=HTTPStatus.INTERNAL_SERVER_ERROR, detail=detail, headers=headers, request_id=request_id)
