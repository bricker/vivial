...
class GPTRequestEvent(_message.Message):
    __slots__ = ["duration_seconds", "eave_request_id", "eave_team_id", "event_time", "feature_name", "file_identifier", "input_cost_usd", "input_prompt", "input_token_count", "model", "output_cost_usd", "output_response", "output_token_count"]
