           ...
           */
            ...
            this.enableRouteHistoryTracking = function(enable) {
                ...
                trackCallbackOnReady(function () {
                    ...
                    function setMethodWrapIfNeeded(contextObject, methodNameToReplace, callback)
                    {
                    ...
                    {
                        setMethodWrapIfNeeded(windowAlias.history, methodNameToReplace, function(state, title, urlParam) {
                    ...
                    addEventListener(windowAlias, 'hashchange', function (event) {
                        var newUrl = getEventUrl(event);
                        trigger('hashchange', newUrl, null);
                    }, false);
                    addEventListener(windowAlias, 'popstate', function (event) {
                        var newUrl = getEventUrl(event);
