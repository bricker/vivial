...
import { COOKIE_CONSENT_GRANTED_EVENT_TYPE } from "../internal/event-types.mjs";
...
class SessionManager {
  ...
  getSessionDurationMs() {
    const start = this.getSessionStartMs();
    if (start === undefined) {
      return;
    }
  ...
  resetOrExtendSession() {
    ...
    let sessionStart = this.getSessionStartMs();
