...
const copy = {
  ...
  slack: {
    ...
    subtitles: ["Once Eave is integrated with your tools, call on Eave as you would with any team member. Eave uses natural language processing to respond to requests and questions.", "Eave uses AI to intelligently parse important information from text and code in order to write cohesive documentation - whether creating new documents or updating existing ones."],
  },
  documentation: {
  ...
  return (
    <Page>
      <main>
        ...
        <IntegrationsBanner title={integrations.title} subtitle={integrations.subtitle} />
        <SlackBanner titles={slack.titles} subtitles={slack.subtitles} />
        <DocumentationBanner title={documentation.title} subtitle={documentation.subtitle} />
