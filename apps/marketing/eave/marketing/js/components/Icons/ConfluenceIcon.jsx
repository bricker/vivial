...
function ConfluenceIcon({ className }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" viewBox="0 0 256 246" className={className} width="16" height="16">
      <defs>
