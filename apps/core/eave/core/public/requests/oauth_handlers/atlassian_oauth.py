...
async def atlassian_oauth_authorize() -> fastapi.Response:
    ...
    oauth_cookies.save_state_cookie(
        ...
        provider=oauth_models.AuthProvider.atlassian,
    )
    return response
...
async def atlassian_oauth_callback(
    ...
    expected_oauth_state = oauth_cookies.get_state_cookie(request=request, provider=oauth_models.AuthProvider.atlassian)
    ...
    oauth_cookies.delete_state_cookie(response=response, provider=oauth_models.AuthProvider.atlassian)
    return response
