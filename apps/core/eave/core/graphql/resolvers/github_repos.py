...
async def create_github_repo(request: Request) -> Response:
...
async def get_github_repo(request: Request) -> Response:
    eave_state = EaveRequestState.load(request=request)
    body = await request.json()
...
async def get_github_repo_all_teams(request: Request) -> Response:
    body = await request.json()
...
async def get_github_repos_feature_state_match(request: Request) -> Response:
...
async def update_github_repos(request: Request) -> Response:
    eave_state = EaveRequestState.load(request=request)
    body = await request.json()
...
async def delete_github_repos(request: Request) -> Response:
    eave_state = EaveRequestState.load(request=request)
    body = await request.json()
