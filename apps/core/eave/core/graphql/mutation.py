...
from eave.core.graphql.resolvers.update_preferences import update_preferences_mutation
...
class Mutation:
    ...
    plan_outing = strawberry.mutation(resolver=plan_outing_mutation, extensions=[AuthenticationExtension(allow_anonymous=True)])
    replan_outing = strawberry.mutation(resolver=replan_outing_mutation, extensions=[AuthenticationExtension(allow_anonymous=True)])
    submit_reserver_details = strawberry.mutation(resolver=submit_reserver_details_mutation, extensions=[AuthenticationExtension()])
    ...
    update_preferences = strawberry.mutation(resolver=update_preferences_mutation, extensions=[AuthenticationExtension()])
