...
class ConnectInstallationResolvers:
    @staticmethod
    def register_connect_installation(input: RegisterConnectInstallationInput) -> ConnectInstallationMutationResult:
    ...
    @staticmethod
    def get_connect_installation(query: QueryConnectInstallationInput) -> Optional[ConnectInstallation]:
        async with eave_db.async_session.begin() as db_session:
    ...
    @staticmethod
    def get_confluence_installation_for_team(team_id: uuid.UUID) -> Optional[ConnectInstallation]:
        ...

    @staticmethod
    def get_jira_installation_for_team(team_id: uuid.UUID) -> Optional[ConnectInstallation]:
        ...