...
class CostBreakdown:
    ...
    def calculate_total_cost_cents(self) -> int:
        ...
        return self.max_base_cost_cents + self.fee_cents + self.tax_cents
    ...
    def __mul__(self, n: int) -> "CostBreakdown":
        return CostBreakdown(
            ...
            max_base_cost_cents=self.max_base_cost_cents * n,
    ...
    def __add__(self, other: "CostBreakdown") -> "CostBreakdown":
        return CostBreakdown(
            ...
            max_base_cost_cents=self.max_base_cost_cents + other.max_base_cost_cents,
