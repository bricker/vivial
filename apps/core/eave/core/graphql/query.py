...
from eave.core.graphql.resolvers.atlassian_installations import query_atlassian_installation
...
from eave.core.graphql.types.connect import ConnectInstallation, ConnectInstallationResolvers
...
from eave.core.graphql.types.github_repo import GithubRepo, GithubRepoFeature, GithubRepoResolvers, GithubReposFeatureStateInput
...
class Query:
    ...
    atlassian_installation: Optional[AtlassianInstallation] = sb.field(resolver=query_atlassian_installation)
