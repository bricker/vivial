...
class ActivitySubcategoryOrm:
    ...
    @classmethod
    def all(cls) -> list["ActivitySubcategoryOrm"]:
        return list(_ACTIVITY_SUBCATEGORIES_TABLE)

    @classmethod
    def one_or_exception(cls, *, activity_subcategory_id: UUID) -> "ActivitySubcategoryOrm":
        return _ACTIVITY_SUBCATEGORIES_PK[activity_subcategory_id]

    @classmethod
    def get_by_eventbrite_id(cls, *, eventbrite_subcategory_id: str) -> "ActivitySubcategoryOrm | None":
        return _ACTIVITY_SUBCATEGORIES_EBID_IDX.get(eventbrite_subcategory_id)

    @classmethod
    def get_by_category_id(cls, *, category_id: UUID) -> list["ActivitySubcategoryOrm"]:
        return _ACTIVITY_SUBCATEGORIES_CATEGORY_ID_IDX.get(category_id, [])


_ACTIVITY_SUBCATEGORIES_TABLE = (
    ActivitySubcategoryOrm(
        id=UUID("bb6ceceeec6c4e0fb12f1a188b89a2da"),
        name="St Patricks Day",
        is_default=True,
        is_manually_curated=False,
        category_id=UUID("c44d71bc95bd4a5bb66a7a97c68250ec"),
    ...
    ActivitySubcategoryOrm(
        ...
        is_default=True,
        is_manually_curated=False,
        category_id=UUID("f3a21e9638d2401ebc290fee6fe44384"),
    ...
    ActivitySubcategoryOrm(
        ...
        is_default=True,
        is_manually_curated=False,
        category_id=UUID("64064c758d894eac9613f23cb6da6fd1"),
    ...
    ActivitySubcategoryOrm(
        ...
        is_default=True,
        is_manually_curated=False,
        category_id=UUID("68917f14a9354a4382829b43d99c9ba8"),
    ...
    ActivitySubcategoryOrm(
        ...
        is_default=True,
        is_manually_curated=False,
        category_id=UUID("988e0bf142564462985a2657602aad1b"),
    ...
    ActivitySubcategoryOrm(
        ...
        is_default=False,
        is_manually_curated=False,
        category_id=UUID("12e3ee96b00641c58e2a6ba3567816d3"),
...
_ACTIVITY_SUBCATEGORIES_PK = MappingProxyType({cat.id: cat for cat in _ACTIVITY_SUBCATEGORIES_TABLE})

_ACTIVITY_SUBCATEGORIES_EBID_IDX = MappingProxyType(
    {ebid: cat for cat in _ACTIVITY_SUBCATEGORIES_TABLE for ebid in cat.eventbrite_subcategory_ids}
)


def _make_category_id_idx() -> MappingProxyType[UUID, list[ActivitySubcategoryOrm]]:
    idx: dict[UUID, list[ActivitySubcategoryOrm]] = {}
    for cat in _ACTIVITY_SUBCATEGORIES_TABLE:
        idx.setdefault(cat.category_id, [])
        idx[cat.category_id].append(cat)
    return MappingProxyType(idx)


_ACTIVITY_SUBCATEGORIES_CATEGORY_ID_IDX = _make_category_id_idx()
