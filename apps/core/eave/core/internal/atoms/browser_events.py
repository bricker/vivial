...
from eave.collectors.core.datastructures import BrowserEventPayload, DatabaseEventPayload, DatabaseStructure, HttpClientEventPayload, HttpServerEventPayload
