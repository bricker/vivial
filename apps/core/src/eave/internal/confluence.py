...
class ConfluenceBaseModel:
    ...
    def __init__(self, data: eave.internal.util.JsonObject, ctx: ConfluenceContext) -> None:
        self._data = data
...
class ConfluencePage(ConfluenceBaseModel):
    ...
    status: str
    title: str
    macro_rendered_output: eave.internal.util.JsonObject
    extensions: eave.internal.util.JsonObject
    ancestors: Optional[list[eave.internal.util.JsonObject]] = None
    container: Optional[eave.internal.util.JsonObject] = None
