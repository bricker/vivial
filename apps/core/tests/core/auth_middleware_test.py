...
class TestAuthenticationMiddlewareRequiredValidRequest(TestAuthenticationMiddlewareBase):
    ...
    async def test_previous_access_token_accepted(self) -> None:
        ...
        assert response.cookies.get("ev_account_id") == str(self._eave_account.id)
        assert response.cookies.get("ev_team_id") == str(self._eave_account.team_id)
        assert response.cookies.get("ev_access_token") == self.getstr("current_token")
    ...
    async def test_access_token_not_refreshed(self) -> None:
        ...
        assert response.cookies.get("ev_access_token") == self.getstr("account.oauth_token")
    ...
    async def test_access_token_refreshed(self) -> None:
        ...
        assert response.cookies.get("ev_access_token") == self.getstr("refreshed_token")
