...
Revision ID: bea023d0efa1
Revises: b2eb47841833
Create Date: 2023-06-01 20:43:34.298783
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("client_key", "id"),
    )
    op.create_index(
        op.f("ix_jira_installations_client_key"),
        "jira_installations",
        ["client_key"],
        unique=True,
    )
    ...
    op.drop_constraint(
        "forge_installations_team_id_fkey",
        "forge_installations",
        type_="foreignkey",
    )
    op.create_foreign_key(
...
def downgrade() -> None:
    ...
    #     ["id"],
    # )
    # op.drop_constraint(None, "forge_installations", type_="foreignkey")
    # op.create_foreign_key(
    #     "forge_installations_team_id_fkey",
    #     "forge_installations",
    #     "teams",
