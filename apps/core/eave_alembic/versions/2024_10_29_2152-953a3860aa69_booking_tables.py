...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("activity_location_address2", sa.String(), nullable=True),
        sa.Column("activity_location_city", sa.String(), nullable=False),
        sa.Column("activity_location_region", sa.String(), nullable=False),
        sa.Column("activity_location_postal_code", sa.String(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("reservation_location_address2", sa.String(), nullable=True),
        ...
        sa.Column("reservation_location_postal_code", sa.String(), nullable=False),
