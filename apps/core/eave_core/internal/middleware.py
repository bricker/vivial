...
from eave_core.internal.database import session_factory
from eave_core.internal.orm import TeamOrm
...
#         api_key = request.headers.get("eave-api-key")
