    ...
    <div className={classes.container}>
      <div className={classes.content}>
        ...
        <h2 className={classNames(text.headerII, text.gray)}>
          We don't currently support your tech stack, but we're working on it. You've been put on our waitlist and we'll
          follow up as soon as we can get you started!
        </h2>
      </div>
