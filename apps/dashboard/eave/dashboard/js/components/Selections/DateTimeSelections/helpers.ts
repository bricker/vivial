...
export function getTimeOptions(selectedDay: Dayjs): TimeObj[] {
  const timesBeforeSixPM = [
    ...
    { label: "6:30am", hour: 6, minute: 0 },
    { label: "7:00am", hour: 7, minute: 0 },
    { label: "7:30am", hour: 7, minute: 0 },
    { label: "8:00am", hour: 8, minute: 0 },
    { label: "8:30am", hour: 8, minute: 0 },
    { label: "9:00am", hour: 9, minute: 0 },
    { label: "9:30am", hour: 9, minute: 0 },
    { label: "10:00am", hour: 10, minute: 0 },
    { label: "10:30am", hour: 10, minute: 0 },
    { label: "11:00am", hour: 11, minute: 0 },
    { label: "11:30am", hour: 11, minute: 0 },
    { label: "12:00pm", hour: 12, minute: 0 },
    { label: "12:30pm", hour: 12, minute: 0 },
    { label: "1:00pm", hour: 13, minute: 0 },
    { label: "1:30pm", hour: 13, minute: 0 },
    { label: "2:00pm", hour: 14, minute: 0 },
    { label: "2:30pm", hour: 14, minute: 0 },
    { label: "3:00pm", hour: 15, minute: 0 },
    { label: "3:30pm", hour: 15, minute: 0 },
    { label: "4:00pm", hour: 16, minute: 0 },
    { label: "4:30pm", hour: 16, minute: 0 },
    { label: "5:00pm", hour: 17, minute: 0 },
    { label: "5:30pm", hour: 17, minute: 0 },
  ];
  const timesAfterSixPM = [
    { label: "6:00pm", hour: 18, minute: 0 },
    { label: "6:30pm", hour: 18, minute: 0 },
    { label: "7:00pm", hour: 19, minute: 0 },
    { label: "7:30pm", hour: 19, minute: 0 },
    { label: "8:00pm", hour: 20, minute: 0 },
    { label: "8:30pm", hour: 20, minute: 0 },
  ];
