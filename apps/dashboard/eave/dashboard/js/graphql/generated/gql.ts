 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation PlanOutingUnauthenticated($input: PlanOutingInput!) {\n  planOuting(input: $input) {\n    ...PlanOutingFields\n  }\n}"): typeof import('./graphql').PlanOutingUnauthenticatedDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation ReplanOutingUnauthenticated($input: ReplanOutingInput!) {\n  replanOuting(input: $input) {\n    ...ReplanOutingFields\n  }\n}"): typeof import('./graphql').ReplanOutingUnauthenticatedDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query ListBookedOutings($input: ListBookedOutingsInput) {\n  viewer {\n    __typename\n    ... on AuthenticatedViewerQueries {\n      __typename\n      bookedOutings(input: $input) {\n        id\n        headcount\n        activityStartTime\n        restaurantArrivalTime\n        drivingTime\n        activity {\n          sourceId\n          source\n          name\n          description\n          websiteUri\n          doorTips\n          insiderTips\n          parkingTips\n          venue {\n            name\n            location {\n              directionsUri\n              latitude\n              longitude\n              formattedAddress\n            }\n          }\n          photos {\n            coverPhotoUri\n            supplementalPhotoUris\n          }\n          ticketInfo {\n            type\n            notes\n            cost\n            fee\n            tax\n          }\n        }\n        restaurant {\n          sourceId\n          source\n          name\n          reservable\n          rating\n          primaryTypeName\n          websiteUri\n          description\n          parkingTips\n          customerFavorites\n          location {\n            directionsUri\n            latitude\n            longitude\n            formattedAddress\n          }\n          photos {\n            coverPhotoUri\n            supplementalPhotoUris\n          }\n        }\n      }\n    }\n    ... on UnauthenticatedViewer {\n      __typename\n      authAction\n    }\n  }\n}"): typeof import('./graphql').ListBookedOutingsDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
