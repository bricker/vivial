 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "fragment UnauthenticatedViewerFields on UnauthenticatedViewer {\n  __typename\n  authAction\n  authFailureReason\n}"): typeof import('./graphql').UnauthenticatedViewerFieldsFragmentDoc;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation PlanOutingAnonymous($input: PlanOutingInput!) {\n  planOuting(input: $input) {\n    ...PlanOutingFields\n  }\n}"): typeof import('./graphql').PlanOutingAnonymousDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation PlanOutingAuthenticated($input: PlanOutingInput!) {\n  viewer {\n    ... on AuthenticatedViewerMutations {\n      __typename\n      planOuting(input: $input) {\n        ...PlanOutingFields\n      }\n    }\n    ...UnauthenticatedViewerFields\n  }\n}"): typeof import('./graphql').PlanOutingAuthenticatedDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation ReplanOutingAnonymous($input: ReplanOutingInput!) {\n  replanOuting(input: $input) {\n    ...ReplanOutingFields\n  }\n}"): typeof import('./graphql').ReplanOutingAnonymousDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation ReplanOutingAuthenticated($input: ReplanOutingInput!) {\n  viewer {\n    ... on AuthenticatedViewerMutations {\n      __typename\n      replanOuting(input: $input) {\n        ...ReplanOutingFields\n      }\n    }\n    ...UnauthenticatedViewerFields\n  }\n}"): typeof import('./graphql').ReplanOutingAuthenticatedDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
