...
eave_ctx = eave.stdlib.logging.LogContext()
...
async def test_slack_message_processing(fixture: dict[str, Any]) -> None:
    ...
    brain = eave.slack.brain.core.Brain(message=message, eave_team=eave_team, slack_ctx=slack_context, eave_ctx=eave_ctx)
