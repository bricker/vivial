...
export function getCronHandler({ dispatchKey }: { dispatchKey: string }): Express.Handler | undefined {
  ...
  switch (dispatchKey) {
    case EAVE_CRON_DISPATCH_KEY_HEADER: return runApiDocumentationCronHandler;
