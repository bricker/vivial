...
export function getEventHandler({ dispatchKey }: { dispatchKey: string }): HandlerFunction | undefined {
  ...
  switch (dispatchKey) {
    case "push": return pushHandler;
    case "pull_request.closed": return pullRequestClosedHandler;
    case "installation_repositories.added": return installationRepoAddedHandler;
