 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query ListBookedOutings($input: AdminListBookingsInput!) {\n  adminBookings(input: $input) {\n    id\n    activityStartTime\n    restaurantArrivalTime\n    activityName\n    restaurantName\n    photoUri\n    state\n  }\n}"): typeof import('./graphql').ListBookedOutingsDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query ReserverDetails($input: AdminReserverDetailsQueryInput!) {\n  adminReserverDetails(input: $input) {\n    id\n    firstName\n    lastName\n    phoneNumber\n  }\n}"): typeof import('./graphql').ReserverDetailsDocument;
