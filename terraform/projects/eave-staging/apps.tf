...
#   iap_jwt_aud = null # "/projects/${data.google_project.default.number}/global/backendServices/${data.google_compute_backend_service["core_api_iap"].generated_id}"
# }
...
#   iap_oauth_client_id               = module.iap.google_iap_client.client_id
#   iap_oauth_client_kube_secret_name = module.shared_kubernetes_resources.iap_oauth_client_kube_secret_name
#   iap_jwt_aud = null # "/projects/${data.google_project.default.number}/global/backendServices/${data.google_compute_backend_service["dashboard"].generated_id}"
# }
